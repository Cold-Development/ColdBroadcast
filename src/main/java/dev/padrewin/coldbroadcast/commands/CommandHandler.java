...
public abstract class CommandHandler implements TabExecutor, NamedExecutor {
     ...
     */
    protected final Map<String, BaseCommand> registeredCommands = new HashMap<>();
    /**
     ...
     */
    protected ColdBroadcast plugin;
     ...
     */
    public CommandHandler(ColdBroadcast plugin, String cmd, CommandManager.CommandAliases aliases) {
        this.plugin = plugin;
        this.cmd = cmd;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        BaseCommand subCommand = this.registeredCommands.get(subcmd);
        if (subCommand == null) {
        ...
        try {
            ...
            sender.sendMessage(ChatColor.RED + "A ColdBroadcast error occurred while executing that command. Did you enter an invalid parameter?");
        }
