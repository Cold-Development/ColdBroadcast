package dev.padrewin.coldbroadcast.manager;
...
import dev.padrewin.coldbroadcast.commands.Commander;
...
public class CommandManager extends Manager {
    ...
    public void reload() {
        ...
        // Register commands
        Commander commander = new Commander((ColdBroadcast) this.coldPlugin);
        PluginCommand command = this.coldPlugin.getCommand("coldbroadcast");
        if (command != null)
